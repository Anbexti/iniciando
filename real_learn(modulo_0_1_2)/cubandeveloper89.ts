...
// Funciones flecha
/*la funcion con flecha se hace "con una variable que guarda la funcion"(const o let)
(IA) y esta funcion no se puede llamar antes de haber sido creada como pasa 
con Function*/
...
// Dos o mas parámetros en una funcion, el tercero es opcinal, el ? es opcional 
